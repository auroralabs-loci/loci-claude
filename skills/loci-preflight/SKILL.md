...
2. **Performance** — fires when MCP timing returned. Captures hot-path
...
3. **Energy** — fires when MCP returned energy. Threshold follows the
...
- **M** = MCP calls to `mcp__plugin_loci_loci__get_assembly_block_exec_behavior`
