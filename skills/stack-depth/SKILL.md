...
```
<venv-python> <plugin-dir>/lib/loci_stats.py record --context-file "<project-context>" --skill stack-depth --functions <N> --mcp-calls 0 --co-reasoning 0 --verdict "<verbatim-verdict-line>"
```
