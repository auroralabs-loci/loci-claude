...
| Network access to `https://loci.auroralabs.com` | — | `exec-trace`, `loci-preflight`, `loci-post-edit` |
...
3. If it still fails, check your network can reach `https://loci.auroralabs.com`.
