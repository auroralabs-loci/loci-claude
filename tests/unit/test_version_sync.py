"""Plugin version must match in pyproject.toml and .claude-plugin/plugin.json.
...
marketplace and package disagree and upgrade detection breaks. Both files must
